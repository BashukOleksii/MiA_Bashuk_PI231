...
using LW4_task_3.FactoryMethod.Service;
...
builder.Services.AddSingleton<ExpectationMessageFactory>();
builder.Services.AddSingleton<ActiveMessageFactory>();
builder.Services.AddSingleton<OverdueMessageFactory>();
builder.Services.AddSingleton<ArchivedMessageFactory>();

builder.Services.AddSingleton<MessageFactoryService>();
