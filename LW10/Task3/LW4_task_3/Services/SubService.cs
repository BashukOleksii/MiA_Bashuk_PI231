...
namespace LW4_task_3.Services
{
    public class SubService : ISubService
    {
        ...
        private readonly MessageFactoryService _messageFactoryService;
        ...
        public async Task CreateAsync(SubscriptionItem element)
        {
            ...
            var factory = _messageFactoryService.GetFactory(element.Status);
            await _messageRepository.CreateAsync(factory.CreateMessage(element));
        }
