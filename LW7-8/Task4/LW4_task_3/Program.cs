...
builder.Services.AddSingleton<IMongoClient>(
    sp => new MongoClient("mongodb+srv://bashuk0325oleksij_db_user:lZHXFstos2k8lAMX@data.t7bzerb.mongodb.net/?retryWrites=true&w=majority&appName=Data")
);
builder.Services.AddSingleton(sp =>
{
    var Client = sp.GetRequiredService<IMongoClient>();
    return Client.GetDatabase("Elements");
});
